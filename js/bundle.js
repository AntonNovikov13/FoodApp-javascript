...
function calculator() {
  ...
  const calorieTotal = document.querySelector('.calculating__total');
  ...
  function calcTotal() {
    if (!sex || !height || !weight || !age || !ratio) {
      calorieTotal.style.visibility = 'hidden';
      return;
    } else {
      calorieTotal.style.visibility = 'visible';
    }
    if (sex === 'female') {
...
function slider(_ref) {
  ...
  function toggleSliderDots(sliderDots) {
...
function timer(id, deadline) {
  ...
  function getTimeRemaining(endtime) {
    ...
    if (t <= 0) {
      ...
      endNotice.classList.add('notice');
      endNotice.innerHTML = 'Акция окончена!';
      const timer = document.querySelector('.promotion__timer');
      timer.append(endNotice);
    } else {
...
/* harmony import */ var _modules_darktheme__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/darktheme */ "./js/modules/darktheme.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_darktheme__WEBPACK_IMPORTED_MODULE_8__["default"])('theme');
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2023-05-20');
